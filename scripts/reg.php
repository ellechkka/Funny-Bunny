<?php
    $l = $_POST["username"];
    $p = $_POST["password"];
    // $user = file_get_contents("https://mysql.lavro.ru/call.php?db=314947&pname=registration&p1=$l&p2=$p");
    ...
    // }
    $result = file_get_contents("https://sql.lavro.ru/call.php?db=314947&pname=registration&p1=$l&p2=$p");
